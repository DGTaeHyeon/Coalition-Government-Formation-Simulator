...
## 기능구성
 1. 선거제도 선택
  ...
  - 소선거구제: 미국을 포함한 다수의 국가가 국회의원 선거의 원칙으로 삼고 있으며, 이를 채택한 대표적 국가는 미국입니다. 준연동형 비례제를 채택한 현재의 우리나라에서도 소선거구제를 국회의원 선거의 기반으로 삼고 있습니다. 제미나이도 이를 한꺼번에 구현하기에는 힘든 점 때문에 큐브의 법칙에 기반을 둔 간이모델을 차탹햐 구현하고 있습니다.
