...
* 기능구성
 1. 선거제도 선택
  ...
  - 연동형 비례대표제: 독일 등의 소수 국가에서 적용하는 연동형 비례대표제를 적용한 결과를 그대로 보여줍니다. 아울러 이 제도 하에서의 초과의석 적용 국가가 독일을 포함해 존재하므로, 초과의석 적용 여부가 개별적 설정으로 독립하기 이전인 버전 1.0에는 이 제도에 배분 중 초과의석 필요 시 초과의석 산출이 자동 적용되어 있습니다.
